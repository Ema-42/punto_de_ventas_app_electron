<template>
  ...
  <div
    v-if="mostrarCard"
    :class="`fixed top-5 z-50 right-5 p-4 text-white rounded-lg shadow-lg ${colorCard}`"
  >
    {{ mensajeCard }}
  </div>
</template>
...
const colorCard = ref("bg-green-500"); // Color por defecto
const mensajeCard = ref("");

const mostrarNotificacion = (mensaje: string, color = "bg-green-500") => {
  mensajeCard.value = mensaje;
...
const eliminarCategoria = () => {
  ...
  mostrarNotificacion("Categoría eliminada", "bg-red-500");
};
